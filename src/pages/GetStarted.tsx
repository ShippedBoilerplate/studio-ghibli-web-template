        ...
        <div className="bg-white rounded-lg shadow-lg p-8 text-left">
          ...
          <form className="space-y-6">
            <div>
              ...
              <input type="text" id="fullname" className="w-full px-4 py-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 font-crimson" />
            </div>
            ...
            <div>
              <label htmlFor="password" className="block text-gray-700 font-crimson text-lg mb-2">Password</label>
              <input type="password" id="password" className="w-full px-4 py-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 font-crimson" />
            </div>
            
            <button type="submit" className="bg-coral hover:bg-opacity-90 text-white font-crimson font-medium px-8 py-3 rounded-md text-lg transition-all duration-300 w-full">
              Start Now
            </button>
          </form>
        </div>
